...
public class AccountOverviewController {
	...
	private void handleDeleteAction(ActionEvent event) {
		ObservableList<Transaction> transactionsList = FXCollections.observableArrayList(transactionsTable.getSelectionModel().getSelectedItems());
		RemoveTransactionCommand removeTransactionCommand = new RemoveTransactionCommand(transactionsList, data);
